    ...
    try:
        ...
        texto_do_td = WebDriverWait(driver, 10).until(
            EC.presence_of_element_located(
                (By.XPATH, '//*[@id="2-panel"]/div/jhi-datatable-dfe/div[2]/div/div[1]/fieldset/table/tbody/tr/td[1]'))
        ).text
        ...
        for i in range(1, numero + 1):
            ...
            numero_xpath = f'//*[@id="2-panel"]/div/jhi-datatable-dfe/div[2]/table/tbody/tr[{i}]/td[2]/a'
            ...
            situacao_xpath = f'//*[@id="2-panel"]/div/jhi-datatable-dfe/div[2]/table/tbody/tr[{i}]/td[8]'
        ...
        try:
            botao_selecione_sit = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, '//*[@id="situacoesForm"]/ng-select'))
            )
            botao_selecione_sit.click()

            botao_sit_aberto = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.XPATH,
                                            '/html/body/jhi-main/div[2]/div/jhi-calculo-nfe/div/jhi-filtros-pesquisa'
                                            '/form/div/fieldset/div/div/div['
                                            '4]/jhi-select-situacoes/form/ng-select/ng-dropdown-panel/div/div[2]/div['
                                            '1]'))
            )
            botao_sit_aberto.click()
            time.sleep(2)
